    ...
    <form method="POST" action="{{ route('barang.update', $barang->id) }}">
        ...
        <div class="mb-4">
            ...
            <textarea id="keterangan" 
                      name="keterangan" 
                      rows="3"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('keterangan', $barang->keterangan) }}</textarea>
        </div>
